...
describe("Board actions", () => {
  ...
  describe("fetchBoardsRequest", () => {
    it("returns the correct object", () => {
      expect(actions.fetchBoardsRequest()).toEqual({
  ...
  describe("fetchBoardsSuccess", () => {
    it("returns the correct object", () => {
      ...
      expect(actions.fetchBoardsSuccess(boards)).toEqual({
  ...
  describe("createBoardRequest", () => {
    it("returns the correct object", () => {
      expect(actions.createBoardRequest()).toEqual({
  ...
  describe("createBoardSuccess", () => {
    it("returns the correct object", () => {
      ...
      expect(actions.createBoardSuccess(board)).toEqual({
